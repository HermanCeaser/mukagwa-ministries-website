...
return [
    ...
    */
    ...
    'support_url' => env('STATAMIC_SUPPORT_URL', 'mailto:admin@mukagwaministries.com'),
    ...
    */
    ...
    'custom_cms_name' => env('STATAMIC_CUSTOM_CMS_NAME', 'Mukagwa Ministries'),

    'custom_logo_url' => env('STATAMIC_CUSTOM_LOGO_URL', '/assets/img/logo-new.png'),

    'custom_dark_logo_url' => env('STATAMIC_CUSTOM_DARK_LOGO_URL', '/assets/img/logo-new.png'),

    'custom_logo_text' => env('STATAMIC_CUSTOM_LOGO_TEXT', 'Mukagwa Ministries CMS'),

    'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', '/assets/img/favicon.png'),

    'custom_css_url' => env('STATAMIC_CUSTOM_CSS_URL', '/assets/css/cp-custom.css'),
