                        ...
                        <form action="#!" id="donet_amount_main_form">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter fast name*"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea rows="7" class="form-control" placeholder="Write your comment"
                                                required></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="donet_amount_form_area doner_content_pbottom">
                                ...
                                <div class="payment_donet_area">
                                    ...
                                    <div class="payment_option_input">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                    ...
                    <div class="sidebar_first">
                        <div class="case_boxed_wrapper">
                            <div class="case_boxed_img">
                                <a href="cause-details.html"><img src="{{ asset('assets/img/causes/causes-1.png') }}" alt="img"></a>
